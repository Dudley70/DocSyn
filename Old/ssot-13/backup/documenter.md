...
Use `/document --scan .` to scan the repository and generate documentation.

```bash
/document --scan . --out docs/
```

This command analyzes the codebase structure and generates comprehensive documentation including API references, module dependencies, and usage examples.



> _Provenance: Synthesised from sourced excerpt in documenter.md on 2025-09-08 14:37 UTC_
